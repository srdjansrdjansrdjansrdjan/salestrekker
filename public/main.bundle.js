...
var appRoutes = [
    ...
    { path: 'form/formCreation', component: __WEBPACK_IMPORTED_MODULE_17__components_form_creation_form_creation_component__["a" /* FormCreationComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'form/finalForm/data/:finalFormUserId', component: __WEBPACK_IMPORTED_MODULE_17__components_form_creation_form_creation_component__["a" /* FormCreationComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'form/finalForm/:finalFormId', component: __WEBPACK_IMPORTED_MODULE_21__components_final_form_final_form_component__["a" /* FinalFormComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__["a" /* AuthGuard */]] },
...
var FormCreationComponent = /** @class */ (function () {
    ...
    FormCreationComponent.prototype.ngOnInit = function () {
        ...
        if (this.finalFormFormId == undefined || this.finalFormFormId == "") {
            this.showFormUrl = false;
            console.log('provera 1 da li je finalFormId: ' + this.showFormUrl);
            setTimeout(function () {
                ...
                if (_this.finalFormFormId == undefined || _this.finalFormFormId == "") {
                    ...
                    console.log('provera 2 da li je finalFormId: ' + _this.showFormUrl);
                    setTimeout(function () {
                        _this.finalFormFormId = _this.dtf.getfinalFormId();
                        _this.showFormUrl = true;
                        console.log('provera 3 da li je finalFormId: ' + _this.showFormUrl);
                        // console.log('ovo je finalFormFormId ako je undefind drugi if: ' +this.finalFormFormId)
                    }, 300);
                }
                _this.showFormUrl = true;
                console.log('provera skroz na kraju da li je finalFormId: ' + _this.showFormUrl);
                // console.log('ovo je finalFormFormId ako je undefind: ' +this.finalFormFormId)
            }, 100);
        }
        console.log("formurl: " + this.showFormUrl);
